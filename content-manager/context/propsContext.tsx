...
interface PageGeneratorContextInterface {
    ...
    setPageGeneratorProp: (componentId: string, propKey: string, propValue: any) => void;
}

export const PageGeneratorContext = createContext<PageGeneratorContextInterface>({
    props: {},
    getPageGeneratorProp: () => { return {} as PageGeneratorProp },
    setPageGeneratorProp: () => { }
});

export const PageGeneratorContextProvider = (props: { children: React.ReactNode }) => {
    const [pageGeneratorProps, setPageGeneratorProps] = useState<PageGeneratorContextInterface["props"]>({
        '123412': {
    ...
    const setPageGeneratorProp = (componentId: string, propKey: string, propValue: any) => {
